...
import templateStyles from '@/components/common/CareerTemplate.module.css'; // For the generic form section
  ...
  return (
    <div className={styles.bespokeContainer}>
      ...
      <section id="apply" className={templateStyles.applicationSection}>
        <div className={templateStyles.applyLayout}>
          ...
          <div className={templateStyles.applyFormContainer}>
            <form className={templateStyles.formElement}>
              ...
              <div className={templateStyles.formRow}>
                ...
                <div className={templateStyles.inputGroup}>
                  ...
                  <CustomSelect 
                    options={[
                      ...electronicsRoles.map(r => ({ id: r.id, label: r.displayTitle })),
              ...
              <div className={templateStyles.inputGroup} style={{ marginTop: '1rem' }}>
                <label>Upload CV (PDF/DOC)</label>
                <div className={templateStyles.fileDrop}>
                  <input type="file" id="cv" required className={templateStyles.hiddenFile} />
                  <label htmlFor="cv" className={templateStyles.fileDropLabel}>
                    <span className={templateStyles.fileDropText}>DROP YOUR CV HERE<br/>PDF / DOC / DOCX</span>
                  </label>
                </div>
              </div>
              ...
              <button type="submit" className={templateStyles.submitBtn}>
                SEND APPLICATION →
              </button>
            </form>
          </div>
